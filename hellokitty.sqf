...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION hellokitty.sqf with invalid parameters: %1",_this];
};
...
_msgStart = ['#FE2EF7',"A heavily armed Hello Kitty fanclub has been spotted, take them out and free this land!"];

// Define Mission Win message
_msgWIN = ['#2EFE2E',"Convicts have successfully taken care of the Hello Kitty fanclub!"];

// Define Mission Lose message
_msgLOSE = ['#FFFF00',"The Hello kitty fanclub have driven off to an other convention!"];

// Define mission name (for map markers, mission messages, and logging)
_missionName = "Hello Kitty Fanclub";
